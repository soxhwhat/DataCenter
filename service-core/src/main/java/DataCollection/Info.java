...
public final class Info {
    ...
    public static final class Holder {
        ...
        public Holder(DataCollection.Info value) {
            this.value = value;
        }
        public DataCollection.Info value;
    }

    public static void __write(Common.OputStream __oput,DataCollection.Info __obj) {
        if (__obj == null) __obj = new DataCollection.Info();
    ...
    public static DataCollection.Info __read(Common.IputStream __iput) throws Common.Exception {
        DataCollection.Info __obj = new DataCollection.Info();
    ...
    public static void __textWrite(Common.OputStream __oput,String __name,DataCollection.Info __obj) {
    ...
    public static DataCollection.Info __textRead(Common.IputStream __iput,String __name,int __idx) {
