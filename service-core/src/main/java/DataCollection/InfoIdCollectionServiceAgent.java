...
public final class InfoIdCollectionServiceAgent {
    ...
    public final boolean getInfoId(final DataCollection.Info info,Common.Holder.String id,final Common.CallParams __params) {
        return getInfoId(__agent,info,id,__params);
    }

    public final void getInfoId_begin(final Common.AgentAsync __async,final DataCollection.Info info,final Common.CallParams __params,final Object __userdata) {
        getInfoId_begin(__agent,__async,info,__params,__userdata);
    }

    public static final boolean getInfoId(final Common.ObjectAgent __agent,final DataCollection.Info info,Common.Holder.String id,final Common.CallParams __params) {
        try {
        int __loop = 0;
        while (true) {
            ...
            case 0:
                ...
                DataCollection.Info.__write(__oput,info);
                break;
    ...
    public static final void getInfoId_begin(final Common.ObjectAgent __agent,final Common.AgentAsync __async,final DataCollection.Info info,final Common.CallParams __params,final Object __userdata) {
