...
public class MongoLogConfiguration {
     ...
     */
    @Bean("logMongoConverter")
    public MappingMongoConverter eventMongoConverter(@Qualifier("logMongodbFactory") MongoDatabaseFactory factory,
    ...
    public MongoTemplate eventMongoTemplate(@Qualifier("logMongodbFactory") MongoDatabaseFactory factory,
                                            @Qualifier("logMongoConverter") MappingMongoConverter converter) {
