...
@Mapper
@Component
public interface AcdCallInfoStatPartMapper extends BaseMapper<AcdCallInfoStatPartPO> {
     ...
     * @return
     */
    AcdCallInfoStatPartPO selectByUniqueKey(@Param("uniqueKey") String uniqueKey);
