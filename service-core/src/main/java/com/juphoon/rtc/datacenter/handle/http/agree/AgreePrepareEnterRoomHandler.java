...
@Component
@Slf4j
public class AgreePrepareEnterRoomHandler extends AbstractAgreeNoticeHandler{
    @Override
    public HandlerId handlerId() {
        return HandlerId.AgreePrepareEnterRoomHandler;
    }

    @Override
    public String endpoint() {
        return "/prepare_enterroom";
    }

    @Override
    public List<EventType> careEvents() {
        return Collections.singletonList(EventType.VERIFY_JOIN);
    }
