...
public abstract class InfoIdCollectionServiceServer extends Common.ObjectServer {
    ...
    public final boolean __ex(Common.ServerCall __call, String __cmd, Common.IputStream __iput) throws Common.Exception {
        if (__cmd.compareTo("getInfoId.InfoIdCollectionService.DataCollection") == 0) {
            __cmd_getInfoId(__call, __iput);
            return true;
        }
        if (__cmd.compareTo("getInfoId.InfoIdCollectionService.Collection") == 0) {
            __cmd_getInfoId(__call, __iput);
            return true;
        }
        return false;
