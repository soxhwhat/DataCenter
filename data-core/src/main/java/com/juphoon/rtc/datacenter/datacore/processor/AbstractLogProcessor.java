...
import com.juphoon.rtc.datacenter.datacore.processor.queue.impl.NoneLogQueueServiceImpl;
import com.juphoon.rtc.datacenter.datacore.processor.queue.impl.ExecutorLogQueueServiceImpl;
    ...
    public void buildQueueService(QueueServiceConfig config) {
        switch (config.getType()) {
            case QUEUE_SERVICE_CONFIG_TYPE_EXECUTOR:
                setQueueService(new ExecutorLogQueueServiceImpl(this, config));
                break;
